...
function TaskDetails({title, setTitle, status, setStatus, priority, setPriority, selectedTag, setSelectedTag,isViewMode}: {title: string; setTitle: (title: string) => void; status: TaskStatus; setStatus: (status: TaskStatus) => void; priority: Priority; setPriority: (priority: Priority) => void; selectedTag: Label | undefined; setSelectedTag: (tag: Label) => void;isViewMode: boolean}) {
  return (
